...
import org.firstinspires.ftc.teamcode.subsystems.teleop.SoMuchTesting.Slides.TestPFFLift;

public class TestSlidePFFControl extends CommandOpMode {
    // DASHBOARD VALUES
    ...
    private TestPFFLift liftSubsystem;
